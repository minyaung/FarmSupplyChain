...
public final class FarmProductTransfer implements ContractInterface {
   ...
   public void initLedger(final Context ctx) {
       ...
       String harvest_date = "08/16/2022";
       String prod_dist_tran_date = "08/16/2022";
       String dist_ret_tran_date = "08/16/2022";
   ...
   public FarmProduct addNewFarmProduct(final Context ctx, 
    ...
    /**
	     ...
	     */
	    @Transaction()
	    public FarmProduct transferToDistributer(final Context ctx, final String productId, final String distributerName, final String distributerAddress, final String transferDate) {
	        ChaincodeStub stub = ctx.getStub();
       ...
       /**
  	     ...
  	     */
  	    @Transaction()
  	    public FarmProduct transferToRetailer(final Context ctx, final String productId, final String retailerName, final String retailerAddress, final String transferDate) {
  	        ChaincodeStub stub = ctx.getStub();
